...
const solvePart1 = (stones: StoneMap): number => {
    return simulateBlinks(stones, 25);
};

const solvePart2 = (stones: StoneMap): number => {
    return simulateBlinks(stones, 75);
};

async function solvePuzzle() {
    const stones = parseInput(input);
    console.log("Answer (P1):", solvePart1(stones));
    console.log("Answer (P2):", solvePart2(stones));
}
