...
const solvePart1 = (numbers: number[]): number => {
...
const solvePart2 = (numbers: number[]): number => {
    const initialDisk = createDiskMap(numbers);
...
async function solvePuzzle() {
    ...
    console.log("Answer (P1):", solvePart1(numbers));
    console.log("Answer (P2):", solvePart2(numbers));
}
